...
const mergedCellAreas = new Set(["1-0-1", "2-3-4", "3-0-1", "3-3-4", "3-3-4", "4-3-4"]); // Merge cột theo từng hàng (ngang)

// Merge vùng: "colIndex-rowStart-rowEnd" 
const mergedRowAreas = new Set(["2-2-3", "2-1-2", "3-3-4", "4-3-4"]); // Merge hàng theo từng cột (dọc)

const CreateBorderLine = (rowCount, rowHeight, tableY, tableX, page, colCount, colWidth) => {
    const lines = [];
