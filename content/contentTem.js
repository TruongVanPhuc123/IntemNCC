...
const Content_Tem = (headers, dataTable, page, tableX, tableY, colWidth, rowHeight, customFont) => {
    const fontSize = 14;
    ...
    dataTable.forEach((row, rowIndex) => {
        ...
        row.forEach((text, colIndex) => {
            ...
            let lines = wrapText(text.toString(), customFont, fontSize, effectiveWidth); // Lấy dòng text
            ...
            let startY = adjustStartY(rowIndex, colIndex, baseY, rowHeight, totalTextHeight, lineHeight, lines); // chỉnh vị trí textX (chiều dọc)
            ...
            lines.forEach((line, i) => {
                ...
                let textX = getTextX(rowIndex, colIndex, tableX, colWidth, effectiveColWidth, textWidth, paddingX); // căn vị trí textY (chiều ngang)
